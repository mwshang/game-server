...
Instance.prototype.__defineGetter__("Players", function () {
    return this.players;
});
Instance.prototype.__defineGetter__("PlayerNum", function () {
    return this.playerNum;
});
Instance.prototype.__defineGetter__("PrivateTables", function () {
    return this.privateTables;
});
Instance.prototype.__defineGetter__("Tables", function () {
    return this.tables;
});
Instance.prototype.__defineGetter__("AiManager", function () {
    return this.aiManager;
});

//是否需要房卡 默认需要 活动期间可能不需要 打完第一把扣除
Instance.prototype.__defineGetter__("isNeedGem", function () {
    return this.app.get(this.serverType)["isNeedGem"];
});

Instance.prototype.__defineGetter__("gameType", function () {
    return this.app.get(this.serverType)["gameType"];
});

//ai 配置
Instance.prototype.__defineGetter__("AiType", function () {
    return this.app.get(this.serverType)["AiType"];
});
...
Instance.prototype.createPrivateTable = function (msg, player) {
    ...
    if (this.isNeedFangKa(msg, player, true)) {
        logger.error("钻石不足,请找代理充值");
        priTable["error"] = "钻石不足,请充值";
        return priTable;
    }
